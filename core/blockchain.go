...
func NewBlockChain(
	...
	txn_f, err := os.OpenFile(logDir+"txn-latency-"+startBlk+"-"+endBlk+".log", os.O_RDWR|os.O_CREATE|os.O_APPEND, 0644)
	if err != nil {
		log.Error("Failed to open transaction log file", "error", err)
		return nil, err
	}
